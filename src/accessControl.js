...
export function visibleNav(user, nav){ const rules={Dashboard:'dashboard.view',Projects:'projects.view',Customers:'customers.view',Quotations:'quotations.view','Jobs & Work Orders':'jobs.view',Inventory:'inventory.view',Invoicing:'invoices.view',Schedule:'projects.view','Budget & Costs':'budget.view',Suppliers:'customers.view',Safety:'safety.view',Reports:'reports.view',Employees:'employees.view','User Access':'users.manage'}; return !rules[nav] || can(user,rules[nav]); }
